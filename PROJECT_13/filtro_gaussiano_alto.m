function g = filtro_gaussiano_alto(f,Do)
%FILTRO_GAUSSIANO_ALTO Realiza a filtragem no dominio da frequencia
%   Aplica um filtro gaussiano passa-alta com Do

%   f = imagem a ser filtrada #1, D0
[M,N] = size(f);
